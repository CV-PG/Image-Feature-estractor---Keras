...
model_weights_path = './models/EfficientNetB1/model_.37-0.81_4class_EfficientNetB1.hdf5'
...
def load_model():
    base_model = EfficientNetB1(input_shape=( 240,240,3), weights='imagenet', include_top=False)
