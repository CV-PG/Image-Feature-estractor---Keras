...
model_weights_path = './models/EfficientNetB3/model_.31-0.84_4class_EfficientNetB3.hdf5'
...
def load_model():
    base_model = EfficientNetB3(input_shape=( 300,300,3), weights='imagenet', include_top=False)
