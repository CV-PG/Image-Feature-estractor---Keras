...
model_weights_path = './models/EfficientNetB2/model_.35-0.83_4class_EfficientNetB2.hdf5'
...
def load_model():
    base_model = EfficientNetB2(input_shape=( 260,260,3), weights='imagenet', include_top=False)
