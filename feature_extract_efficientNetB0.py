...
# feature extraction from EfficientNetB0 4-class model
# 1) finetuned 
# 2) pre-trained 
...
model_weights_path ='./models/EfficientNetB0/model_.45-0.80_4class_EfficientNetB0.hdf5'
...
##-------Load Finetuned EfficientNetB0 model bised on new weights ------------###
def load_model():
...
##-------Load Pre-train EfficientNetB0 model bised on imagenet weights ------------###
